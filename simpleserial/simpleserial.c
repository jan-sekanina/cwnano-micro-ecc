...
uint8_t ss_version(uint8_t *v, uint16_t len) {
    return 0x00;
}

uint8_t ss_num_commands(uint8_t *x, uint16_t len)
{
...
void simpleserial_init() {
    simpleserial_addcmd('v', 0, ss_version);
